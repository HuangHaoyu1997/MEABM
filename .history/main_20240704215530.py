...
if __name__ == '__main__':
    ...
    axs[0].plot(price_history)
    axs[0,0].set_xlabel('Time/Month'); axs[0].set_ylabel('Price')
    
    axs[1].plot(rate_history)
    axs[1].xlabel('Time/Month'); axs[1].ylabel('Interest rate')

    plt.tight_layout()
    plt.savefig('log.png', bboxes_inches='tight', dpi=300)
    # plt.show()
